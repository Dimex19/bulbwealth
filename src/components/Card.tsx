...
const Card = ({title, paragraph, src, className}: myCardProps) => {
  return (
    <div className={`flex flex-col justify-center items-center w-[414.98px] h-[414.98px]text-[14px] font-medium text-white bg-[#1A2635A3] pt-[81px] pb-[82.98px] pr-[36.98px] pl-[36px] border-1 border-[#667B96] rounded-[10px] ${className}`}>
