...
const Product:React.FC = () => {
  return (
    <div className="w-full flex flex-col relative mb-[125px]">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-10 pl-[5vw] pr-[5vw] md:pl-[14vw] md:pr-[14vw] font-[Inter]">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-10  pl-[5vw] pr-[5vw] md:pl-[14vw] md:pr-[14vw]">
