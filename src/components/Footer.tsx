...
const Footer:React.FC = () => {
  return (
    <>
        ...
        <div className="flex justify-between pl-[32px] pr-[32px] mb-[64px] border-b border-transparent" 
     style={{ borderBottomColor: 'rgba(190, 194, 201, 0.5)' }}>
                <div className=''>
                ...
                <ButtonProps text='Subscribe' className='w-[131px] h-[44px] rounded-[50px] border-1 border-[#7F56D9] bg-[#6C6CFF] transition-all ease-in-out hover:bg-[#7F56D9]'/>
                </div>
            </div>
        </div>
        <div className='pl-[80px] pr-[80px]'>
            <div className="flex justify-between text-white pl-[32px] pr-[32px] mb-[64px]">
                <div>
                    <img src={Logo} alt="" />
